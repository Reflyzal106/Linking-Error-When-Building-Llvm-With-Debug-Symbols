# [SOLVED] Linking-Error-When-Building-Llvm-With-Debug-Symbols
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/linking-error-when-building-llvm-with-debug-symbols)
>
...
The issue is likely due to the missing `--target` option in the `cmake` command. Add `--target x86_64-unknown-linux-gnu` to specify the target architecture for building LLVM.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/linking-error-when-building-llvm-with-debug-symbols)**
